...
@XmlJavaTypeAdapters({
    ...
    @XmlJavaTypeAdapter(value = DoubleAdapter.class, type = Double.class),
    @XmlJavaTypeAdapter(value = SalNodeAdapter.class, type = SalNode.class),
    @XmlJavaTypeAdapter(value = VnodeNameAdapter.class, type = VnodeName.class),
    @XmlJavaTypeAdapter(value = VlanIdAdapter.class, type = VlanId.class),
})
...
import org.opendaylight.vtn.manager.util.xml.adapters.VlanIdAdapter;
import org.opendaylight.vtn.manager.util.xml.adapters.VnodeNameAdapter;

import org.opendaylight.vtn.manager.internal.util.inventory.SalNode;
import org.opendaylight.vtn.manager.internal.util.inventory.SalNodeAdapter;
