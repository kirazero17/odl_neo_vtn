 ...
 */
@XmlRootElement(name = "vbridge-if-path")
...
public final class VBridgeIfIdentifier extends VInterfaceIdentifier<Vbridge> {
     ...
     */
    public static VBridgeIfIdentifier create(
        ...
        VnodeName ifName = VNodeType.VBRIDGE_IF.checkName(iname, find);
        return new VBridgeIfIdentifier(vtnName, vbrName, ifName);
    }
